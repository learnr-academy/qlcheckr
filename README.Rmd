...
Consider checking code that might generate errors, which can be obtained in Quarto Live check environments with the `errors()` helper. `exists_in()` can again be used to search for specific errors.
